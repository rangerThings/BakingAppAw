package com.rangerthings.bakingapp.Widget;
...
public class IngredientsAppWidget extends AppWidgetProvider {
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setTextViewText(R.id.appwidget_text, ingredientsText);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (AppWidgetManager.ACTION_APPWIDGET_UPDATE.equals(strAction)) {
            ingredientsText = strAction;
            Log.d("String", ingredientsText);
        }
    }
}
